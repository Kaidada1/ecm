export const FIND_PROUCT_BY_ID_REQUEST='FIND_PRODUCT_BY_ID_REQUEST'
export const FIND_PROUCT_BY_ID_SUCCESS='FIND_PRODUCT_BY_ID_SUCCESS'
export const FIND_PROUCT_BY_ID_FAILURE='FIND_PRODUCT_BY_ID_FAILURE'
